...
## [0.6.5+raux.0.2.4] 2025-08-28

### Fixed
- **🖥️ Installation Error Display**: Fixed installation failures showing blank screens instead of error messages in the terminal display.
...
### Changes
- **🟢 Branding Update** Updated branding to match GAIA
- **⬆️ Simplify Install** Remove generic vs hybrid flow
